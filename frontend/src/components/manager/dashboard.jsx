        ...
        <div className="flex flex-col h-full w-full bg-gradient-to-r from-blue-50 to-blue-100 ">
            ...
            {toggleedit &&
                <div className="flex  h-2/3 w-full mt-8" >
                    <div className="md:order-1 w-11/12 md:w-2/6 md:h-4/5 h-4/6 flex flex-col justify-center items-center ml-3 shadow-2xl rounded-xl bg-white">
            ...
            {togglepassword &&
                <div className="flex  h-2/3 w-full mt-8 " >
                <div className="md:order-1 w-11/12 md:w-2/6 md:h-4/5 h-4/6 flex flex-col justify-center items-center ml-3 shadow-2xl rounded-xl bg-white">
                    <form onSubmit={handlepasswordsubmit} className=" flex  flex-col justify-center items-center">
                        <h1 className="font-serif font-bold mb-6">Edit Password</h1>
                        <div className="flex mb-4 w-11/12 justify-evenly">
                            <label className="mr-1" >Old Password:</label>
                            <input type="password"  value={enteredOldPassword}  onChange={(e) => setEnteredOldPassword(e.target.value)} className="bg-slate-200 rounded-md border-none focus:outline-none" />
                        </div>
                        <div className="flex mb-1 w-11/12 justify-evenly">
                            <label className="mr-1" >New Password:</label>
                            <input type="text"  onChange={(e)=>setNewPassword(e.target.value)}  className="bg-slate-200 rounded-md border-none focus:outline-none" />
                        </div>
